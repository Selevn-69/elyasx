  ...
  return (
    <header className="fixed top-0 right-0 h-20 left-[240px] bg-surface dark:bg-background flex items-center justify-between px-gutter z-40 border-b border-outline-variant/10">
      ...
      <div className="flex items-center gap-lg">
        ...
        <div className="flex items-center gap-sm bg-surface-container-low px-md py-xs rounded-full border border-outline-variant/30">
          <div className="w-8 h-8 rounded-full bg-[#F97316] flex items-center justify-center text-white font-label-bold">
            A
          </div>
          <span className="font-label-bold text-label-bold text-on-surface">Admin</span>
        </div>
      </div>
    </header>
  )
